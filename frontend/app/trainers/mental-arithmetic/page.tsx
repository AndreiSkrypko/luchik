...
const modules = [
  {
    ...
    title: 'Просто',
    description:
      'Тренировки на базовые вычисления и уверенную работу с маленькими числами. Подходит для быстрого разогрева перед более сложными заданиями.',
  ...
  },
  {
    ...
    title: 'Братья',
    description:
      'Учимся находить связи между соседними числами и быстро определять результат без механического пересчёта.',
  ...
  },
  {
    ...
    title: 'Друзья',
    description:
      'Ищем пары чисел, которые составляют заданную сумму. Развивает внимательность и мгновенное узнавание комбинаций.',
  ...
  },
  {
    ...
    title: 'Друг+брат',
    description:
      'Комбинируем сразу две стратегии: находим «друзей» и «братьев» в одном задании. Тренирует переключение внимания.',
  ...
  },
  {
    ...
    description:
      'Повторяем классическую таблицу умножения в игровом формате. Закрепляем память и скорость воспроизведения фактов.',
  ...
  },
  {
    ...
    title: 'Умножение',
    description:
      'Практикуем перемножение двузначных и трёхзначных чисел в уме. Укрепляем арифметику и концентрацию.',
  ...
  },
  {
    ...
    description:
      'Особый тренажёр на быстрый счёт в пределах двадцати. Помогает уверенно переходить к большим числам.',
  ...
  },
  {
    ...
    description:
      'Осваиваем технику умножения от ближайшей базы (10, 50, 100). Идеально для олимпиадных задач и устных ответов.',
  ...
  },
  {
    ...
    title: 'Хитрости',
    description:
      'Собираем математические лайфхаки: сокращения, приёмы и быстрые способы решений, чтобы считать непривычные примеры.',
  ...
  },
  {
    ...
    title: 'Квадраты',
    description:
      'Запоминаем квадраты чисел и учимся находить их в голову. Поможет в алгебраических преобразованиях и оценках.',
  ...
  },
  {
    ...
    title: 'Флэшкарты',
    description:
      'Комбинируем визуальные карточки с числами и ответами. Отличный способ отработать реакции и закрепить результаты.',
